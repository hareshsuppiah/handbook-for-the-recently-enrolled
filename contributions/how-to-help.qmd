...
![The contributor submits a suggestion; an editor checks it; Haresh approves drafting; a human or available AI agent proposes edits; Haresh reviews before publication.](../assets/contributions/suggestion-steps.svg){fig-alt="Five stages: submit a suggestion, editorial check and Haresh decision, human or AI drafting, Haresh review, then publication of accepted changes."}
...
This is an instructional diagram, not a screenshot. The field names match the handbook form checked on 5 September 2026; GitHub's layout may change.
...
| Your situation | Choose this option | Example |
|---|---|---|
| The book does not answer your question | Add a missing question, topic, checklist, template or example | How do I find a peer group? |
| Existing wording is wrong or hard to understand | Correct or clarify something | This sentence confuses approval with publication. |
| Material repeats itself or is unnecessary | Shorten, combine or remove something | Two lists ask me to do the same check. |
| You have supporting material | Share a source or useful example | An official guide supports this distinction. |
| Something is hard to read or operate | Report a reading, navigation, accessibility or technical problem | A table is cut off on my phone. |
| Advice depends on context | Clarify where advice does and does not apply | This leave rule applies only at my university. |
| None of those fits | Something else | Explain the outcome you want in your own words. |
...
| Merge | Accept the edits into the main handbook source | Haresh handles the publication decision. |
